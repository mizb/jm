...
$expectedApiVersion = '2026.07.17.2'
...
Assert-Contains $compose 'JM_MAX_UPSTREAM_ATTEMPTS:\s*"\$\{JM_MAX_UPSTREAM_ATTEMPTS:-10\}"' 'shared upstream attempt limit defaults to two domain passes and accepts an override'
